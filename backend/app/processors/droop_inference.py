...
_ASYM_GATE = 0.030
# When asymmetry is above the gate, blend CNN and asymmetry (weight reaches 1.0 at this value).
_ASYM_SCALE = 0.08
...
class DroopModel:
    def __init__(
        ...
        logger.info("DroopModel loaded. threshold=%.4f", self.threshold)
    ...
    def predict(self, image_bytes: bytes) -> dict:
        ...
        features = detect_face_features(
            rgb,
            target_size=self.image_size,
            model_path=self._face_landmarker_path,
        )
